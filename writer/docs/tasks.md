...
- [ ] **T18.1** AI 配置默认测试问题 + 模型状态指示器 (ui-ai-config.js, style.css)
...
- [ ] **T18.5** 底部"更新设定"按钮 (ui-chat.js, ui-setting-update.js 新文件)
  - 聊天框底部按钮栏增加 [更新设定] 按钮
  - 下载 jsdiff 库到 vendor/
...
- [ ] **T18.6** 提示词优化重构为左右栏布局 (ui-prompt-opt.js)
  - 从弹窗改为侧边栏+正文区域的两栏布局
...
- [ ] **T18.7** 编写 P18 测试用例并运行

- [ ] **T18.8** Git commit: "feat(writer): P18 UI 增强与提示词优化重构"
